...
//From https://stackoverflow.com/questions/3734796/how-to-customize-message-box user Alex Jolig
...
namespace MyStuff
{
    ...
    public class MyButton : Button
    {
        public static Button Set(string Text = "", int Width = 102, int Height = 30, Font Font = null, Color ForeColor = new Color(), Color BackColor = new Color())
        {
            ...
            b.Width = Width;
            b.Height = Height;
            b.Font = (Font == null) ? new Font("Microsoft Sans Serif", 8.25F) : Font;
            b.ForeColor = (ForeColor == new Color()) ? SystemColors.GradientInactiveCaption : ForeColor;
            b.BackColor = (BackColor == new Color()) ? System.Drawing.Color.FromArgb(((int)(((byte)(50)))), ((int)(((byte)(50)))), ((int)(((byte)(50))))) : BackColor;
    ...
    public class MyImage : PictureBox
    {
        public static PictureBox Set(string ImagePath = null, int Width = 60, int Height = 60)
        {
            ...
            if (ImagePath != null)
            {
                ...
                i.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(50)))), ((int)(((byte)(50)))), ((int)(((byte)(50)))));
            }
            else
            {
                i.Visible = true;
    ...
    public partial class MyMessageBox : Form
    {
        ...
        public static string Show(List<Label> Labels = null, string Title = "", List<Button> Buttons = null, PictureBox Image = null)
        {
            ...
            foreach (Label l in Labels)
            {
                ...
                l.MaximumSize = new Size(800, 5000);
                il.Add(l.Width);
            }
